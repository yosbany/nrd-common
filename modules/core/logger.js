...
export function createLogger(appName, options = {}) {
  return new Logger(appName, {
    logLevel: options.logLevel !== undefined ? options.logLevel : LOG_LEVELS.INFO,
    enableColors: options.enableColors !== undefined ? options.enableColors : true,
    enableTimestamp: options.enableTimestamp !== undefined ? options.enableTimestamp : true,
    enableStack: options.enableStack !== undefined ? options.enableStack : false
  });
}

// Note: Each project should create its own logger instance after syncing
// Example:
// export const logger = new Logger('NRD MyApp', {
